---
title: "(Chinese) 深入浅出 boltdb —— 0x00 引言"
date: "2021-01-05"
summary: "深入浅出 boltdb —— 0x00 引言"
...
与前一个《深入浅出 etcd/raft》系列相比，boltdb更多偏向工程实现而非算法，因此本系列不会逐行地分析每一行源码。


## 1. 目录

- [深入浅出 boltdb —— 0x00 引言](/posts/code-reading/boltdb-made-simple/0-introduction/)
- [深入浅出 boltdb —— 0x01 存储与缓存](/posts/code-reading/boltdb-made-simple/1-storage-cache/)
- [深入浅出 boltdb —— 0x02 B+Tree](/posts/code-reading/boltdb-made-simple/2-b+tree/)
- [深入浅出 boltdb —— 0x03 bucket & cursor](/posts/code-reading/boltdb-made-simple/3-bucket-cursor/)
- [深入浅出 boltdb —— 0x04 事务](/posts/code-reading/boltdb-made-simple/4-transaction/)
